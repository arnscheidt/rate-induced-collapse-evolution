...
plt.xlim(0,120000)
plt.ylim(0,330)
plt.text(25000,290,r'$\beta=1.0\times10^{-5}$',horizontalalignment='center')
plt.text(65000,290,r'linear ramp',horizontalalignment='center')
plt.text(100000,290,r'$\beta=1.3\times10^{-4}$',horizontalalignment='center')
...
plt.text(95000,290,r'$\beta=1.3\times10^{-4}$',horizontalalignment='center')
